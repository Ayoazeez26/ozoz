...
<template>
  <div
    class="w-screen h-screen flex items-center justify-center relative overflow-hidden">
    <img
    ...
    <img
      src="/svg/branch.svg"
      alt="branch image"
      class="absolute hidden md:block top-[100px] left-0 z-0" />
    <img
      src="/svg/branch.svg"
      alt="branch image"
      class="absolute hidden md:block top-[100px] right-3 rotate-[105deg] z-0" />
    <img
      src="/svg/branch.svg"
      alt="branch image"
