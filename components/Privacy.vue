...
<template>
  <div class="flex items-center justify-center relative overflow-hidden">
    ...
    <div
      class="flex flex-col text-center text-brown items-center px-4 md:px-0 pt-[238px] w-full max-w-[1040px] pb-80">
      <p class="text-sm/[19px] tracking-[-1.5%]">
        Last updated: November 16, 2024
      </p>
      <h1 class="text-red-2 text-[60px]/[72px] font-semibold tracking-[-1.5%]">
        Privacy Policy
      </h1>
      <p class="text-lg/[28px] md:text-xl/[28px] tracking-[-1.5%] my-6">
        This Privacy Policy describes Our policies and procedures on the
        collection, use and disclosure of Your information when You use the
        Service and tells You about Your privacy rights and how the law protects
        You.
      </p>
      <p class="text-lg/[28px] md:text-xl/[28px] tracking-[-1.5%]">
        We use Your Personal data to provide and improve the Service. By using
        the Service, You agree to the collection and use of information in
        accordance with this Privacy Policy.
      </p>
      <div class="mt-10 flex flex-col gap-6 w-full text-left">
        <h2 class="text-red-2 font-semibold text-5xl/[57.6px] tracking-[-1/5%]">
          Interpretation and Definitions
        </h2>
        <h4 class="font-semibold text-red-2 text-2xl/[28.8px] tracking-[-1.5%]">
          Interpretation
        </h4>
        <p class="text-lg/[28px] md:text-xl/[28px] tracking-[-1.5%]">
        ...
        <p class="text-lg/[28px] md:text-xl/[28px] tracking-[-1.5%]">
          ...
          <br /><br />
          <span class="font-bold">Account</span> means a unique account created
          for You to access our Service or parts of our Service. <br /><br />
          <span class="font-bold">Affiliate</span> means an entity that
          controls, is controlled by or is under common control with a party,
          where "control" means ownership of 50% or more of the shares, equity
          interest or other securities entitled to vote for election of
          directors or other managing authority. <br /><br />
          <span class="font-bold">Company</span> (referred to as either "the
          Company", "We", "Us" or "Our" in this Agreement) refers to Ozoz Sokoh.
          <br /><br />
          <span class="font-bold">Cookies</span> are small files that are placed
          ...
          its many uses. <br /><br />
          <span class="font-bold">Country</span> refers to: Ontario, Canada
          <br /><br />
          <span class="font-bold">Device</span> means any device that can access
          the Service such as a computer, a cellphone or a digital tablet.
          Personal Data is any information that relates to an identified or
          identifiable individual. <br /><br />
          <span class="font-bold">Service</span> refers to the Website.
          <br /><br />
          <span class="font-bold">Service Provider</span> means any natural or
          ...
          <span class="font-bold">Usage Data</span> refers to data collected
          ...
          visit). <br /><br />
          <span class="font-bold">Website</span> refers to Ozoz Sokoh,
          accessible from https://www.ozozsokoh.com/ <br /><br />
          <span class="font-bold">You</span> means the individual accessing or
      ...
      <div class="mt-10 flex flex-col gap-6 w-full text-left">
        ...
        <h3
          class="font-semibold text-red-2 text-[32px]/[38.4px] tracking-[-1.5%]">
        ...
        <div class="flex flex-col">
          ...
          <ul class="list-disc pl-8 flex flex-col gap-6">
            <li class="text-lg/[28px] md:text-xl/[28px] tracking-[-1.5%]">
              <span class="font-bold">Cookies or Browser Cookies.</span> A
            ...
            <li class="text-lg/[28px] md:text-xl/[28px] tracking-[-1.5%]">
              <span class="font-bold">Web Beacons.</span> Certain sections of
          ...
          <p class="text-lg/[28px] md:text-xl/[28px] tracking-[-1.5%] mt-6">
        ...
        <p class="text-lg/[28px] md:text-xl/[28px] tracking-[-1.5%]">
          ...
          below:
          <br /><br />
          <span class="font-bold">Necessary / Essential Cookies</span><br />
          ...
          <span class="font-bold">Functionality Cookies</span><br />
          Type: Persistent Cookies<br />
          Administered by: Us<br />
        ...
        <p class="text-lg/[28px] md:text-xl/[28px] tracking-[-1.5%]">
          ...
          <br /><br />
          <span class="font-bold">To provide and maintain our Service,</span>
          including to monitor the usage of our Service. <br /><br />
          <span class="font-bold">To manage Your Account:</span> to manage Your
          ...
          are available to You as a registered user. <br /><br />
          <span class="font-bold">For the performance of a contract:</span> the
          ...
          contract with Us through the Service. <br /><br />
          <span class="font-bold">To contact You:</span> To contact You by
          ...
          <span class="font-bold">To provide You with news,</span> special
          ...
          information. <br /><br />
          <span class="font-bold">To manage Your requests:</span> To attend and
          manage Your requests to Us. <br /><br />
          <span class="font-bold">For business transfers:</span> We may use Your
          ...
          <br /><br />
          <span class="font-bold">For other purposes:</span> We may use Your
        ...
        <div class="flex flex-col">
          ...
          <ul class="list-disc pl-8 flex flex-col gap-6">
            ...
            <li class="text-lg/[28px] md:text-xl/[28px] tracking-[-1.5%]">
              <span class="font-bold">With Affiliates:</span> We may share Your
            ...
            <li class="text-lg/[28px] md:text-xl/[28px] tracking-[-1.5%]">
              <span class="font-bold">With business partners:</span> We may
              share Your information with Our business partners to offer You
              certain products, services or promotions. With other users: when
            ...
            <li class="text-lg/[28px] md:text-xl/[28px] tracking-[-1.5%]">
              <span class="font-bold">With Your consent:</span> We may disclose
        ...
        <div class="flex flex-col mt-3">
          <h4
            class="font-semibold text-red-2 text-2xl/[28.8px] tracking-[-1.5%] mb-6">
            Disclosure of Your Personal Data
          </h4>
          <p class="text-lg/[28px] md:text-xl/[28px] tracking-[-1.5%]">
            <span class="font-bold">Business Transactions</span><br />
            If the Company is involved in a merger, acquisition or asset sale,
            Your Personal Data may be transferred. We will provide notice before
            Your Personal Data is transferred and becomes subject to a different
            Privacy Policy.<br /><br />
            <span class="font-bold">Law enforcement</span><br />

            Under certain circumstances, the Company may be required to disclose
            Your Personal Data if required to do so by law or in response to
            valid requests by public authorities (e.g. a court or a government
            agency).<br /><br />
            <span class="font-bold">Other legal requirements</span><br />
          ...
          <p class="text-lg/[28px] md:text-xl/[28px] tracking-[-1.5%] mt-6">
            <span class="font-bold">Security of Your Personal Data</span><br />
        ...
        <div class="flex flex-col mt-3">
          ...
          <ul class="list-disc pl-8 flex flex-col gap-6">
            ...
            <li class="text-lg/[28px] md:text-xl/[28px] tracking-[-1.5%]">
              ...
              By visiting this page on our website: <nuxt-link to="/contact" target="_blank" class="text-red">https://www.ozozsokoh.com/contact</nuxt-link>
            </li>
          </ul>
        </div>
      </div>
