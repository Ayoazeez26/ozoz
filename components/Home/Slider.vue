...
<template>
  <div class="w-[287px] mx-auto md:w-full max-w-[1068px] text-brown">
    ...
    <Swiper
        ...
        <div class="w-full flex items-start">
          <div class="w-full">
            <img
              ...
              class="w-full max-w-[280px]" />
            <p class="mt-5 text-lg/[140%]">
              In <span class="font-bold">2018</span> Sokoh created
      ...
      <!-- <SwiperSlide
        class="w-[287px!important] max-w-[287px!important] invisible md:min-w-[367px!important] md:max-w-[367px!important]">
        <div class="w-full flex items-start">
          <div class="w-full">
            <img
              src="/img/journey1.webp"
